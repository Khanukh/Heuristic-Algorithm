...
%% algorithm
 tic
[Best_score,Best_pos,WOA_cg_curve]=WOA(SearchAgents_no,Max_iteration,lb,ub,dim,fobj,(whale_z/10-0.1),(wolf_z/10-0.1));
tend = toc;
excel_ouput(1,i) = i;
...
sensitivity(whale_z,wolf_z,1) = excel_ouput(5,number_of_test+1);
sensitivity(whale_z,wolf_z,2) = excel_ouput(4,number_of_test+3);
sensitivity(whale_z,wolf_z,3) = excel_ouput(3,number_of_test+1);
    end
end
